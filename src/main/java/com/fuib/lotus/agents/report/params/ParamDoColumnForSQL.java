...
public class ParamDoColumnForSQL extends ParamDocColumn {
    ...
    public ParamDoColumnForSQL(String colName, String sParamValue, String sParamDescription, boolean bHasSqlNullIfEmpty, ParamDocColSet parentColumnSet) {
        super(colName, sParamValue, sParamDescription, parentColumnSet);
